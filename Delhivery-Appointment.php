            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">Delhivery Appointment</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Menu</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">B2B panel</a></li>
                                <li class="breadcrumb-item active">Delhivery-Appointment</li>
                            </ol>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table " style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td><b>TRUXCARGO1821</b> <br>
                                        Shashank Shukla
                                        (7388408430)</td>
                                    <td>263157108</td>
                                    <td class="date">10:00 AM-12:00 PM</td>
                                    <td>CHC10956</td>
                                    <td>Alok Kumar </td>
                                    <td> </td>
                                    <td>87654356</td>
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-placement="top" title="Remark">
                                                <a href="" data-bs-toggle="modal" id="cashIn-btn"
                                                    data-bs-target="#cashInModal" class="text-success d-inline-block">
                                                    <svg width="30" height="29" viewBox="0 0 30 29" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M23 0.125H7C5.30965 0.126324 3.68891 0.798399 2.49366 1.99366C1.2984 3.18891 0.626324 4.80965 0.625 6.5V22.5C0.626324 24.1903 1.2984 25.8111 2.49366 27.0063C3.68891 28.2016 5.30965 28.8737 7 28.875H23C24.6903 28.8737 26.3111 28.2016 27.5063 27.0063C28.7016 25.8111 29.3737 24.1903 29.375 22.5V6.5C29.3737 4.80965 28.7016 3.18891 27.5063 1.99366C26.3111 0.798399 24.6903 0.126324 23 0.125ZM25.295 14.73C25.11 14.975 20.645 20.73 15 20.73C9.355 20.73 4.89 15 4.705 14.73C4.65391 14.6642 4.62618 14.5833 4.62618 14.5C4.62618 14.4167 4.65391 14.3358 4.705 14.27C4.89 14.025 9.355 8.27 15 8.27C20.645 8.27 25.11 14.01 25.295 14.27C25.3461 14.3358 25.3738 14.4167 25.3738 14.5C25.3738 14.5833 25.3461 14.6642 25.295 14.73Z"
                                                            fill="#7939CC" />
                                                        <path
                                                            d="M15.0013 18.2203C17.0557 18.2203 18.7212 16.5548 18.7212 14.5003C18.7212 12.4458 17.0557 10.7803 15.0013 10.7803C12.9468 10.7803 11.2812 12.4458 11.2812 14.5003C11.2812 16.5548 12.9468 18.2203 15.0013 18.2203Z"
                                                            fill="#7939CC" />
                                                    </svg>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3">
                        <h5 class="modal-title" id="cashInModalLabel">Add Remark
                        </h5>
                    ...
                    <form class="tablelist-form" autocomplete="off">
                        <div class="modal-body">
                            <p>Current status is : <span style="color: #7E7EFF">Open</span>
                            </p>
