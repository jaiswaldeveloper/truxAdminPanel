...
#sample .table-nowrap td,
#sample .table-nowrap th {
    white-space: normal;
}
</style>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">Bluedart Series</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Menu</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">B2B panel</a></li>
                                <li class="breadcrumb-item active">Bluedart Series</li>
                            </ol>
                        </div>
            ...
            <div class="plan-overview">
                <div class="row justify-content-center">
                    <h5 class="text-white">Import Series </h5>
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td>1</td>
                            ...
                            <td style="cursor: pointer">  <i class="fs-20 text-danger ri-close-circle-fill"></i> </td>
