            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">All Warehouse
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">All Warehouse
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                    ...
                                    <div class="mt-3 mt-lg-0">
                                        <div class="col-auto">
                                            <a href="Add-New-warehouse.php" class="btn btn-primary" ><i
                                ...
                                <div class="col-xxl-5 col-sm-6">
                                    <div class="search-box">
                                        <input type="text" class="form-control search"
                                            placeholder="Search by Warehouse, Customer Name, Phone no">
                    ...
                    <table id="example" class="table " style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><button data-bs-toggle="modal" id="cashIn-btn" data-bs-target="#cashInModal"
                                        class="btn btn-danger"
                                        style="background: linear-gradient(360deg, #BC3C43 0%, #ED1C24 100%);"> More
                                        Info</button> </td>
            ...
            <div class="modal-dialog  modal-lg modal-dialog-centered">
                <div class="modal-content ">
                    <div class="modal-header bg-light p-3">
                        <h5 class="modal-title" id="cashInModalLabel" style="color:#7E7EFF">PICKUP POINT DETAILS
                        </h5>
                    ...
                    <form class="tablelist-form" autocomplete="off">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-xxl-3">
                                    <small>Pickup Point Name
                                    </small>
                                    <p style="color:#7E7EFF">ankita jian 011</p>
                                </div>
                                <div class="col-xxl-3">
                                    <small> Contact Name
                                    </small>
                                    <p style="color:#7E7EFF">ANKITA JAIN</p>
                                </div>
                                <div class="col-xxl-3">
                                    <small>Phone Number
                                    </small>
                                    <p style="color:#7E7EFF">9865896575</p>
                                </div>
                                <div class="col-xxl-3">
                                    <small>Pickup Point Name
                                    </small>
                                ...
                                <div class="col-xxl-3">
                                    ...
                                    <p style="color:#7E7EFF">CYGINI ENERGY PVT LTD SURVEY NO 306 PLOT NO 5 EMC
                                        MAHESSHWARAM
                                        INDUSTRIAL AREARANGAREDDY</p>
                                </div>
                                <div class="col-xxl-3">
                                    <small>Pincode
                                    </small>
                                    <p style="color:#7E7EFF">501359</p>
                                </div>
                                <div class="col-xxl-3">
                                    <small>City
                                    </small>
                                    <p style="color:#7E7EFF">Hyderabad</p>
                                </div>
                                <div class="col-xxl-3">
                                    <small>State
                                    </small>
                                    <p style="color:#7E7EFF">Telegana</p>
                                </div>
                            </div>

                            <div class="mt-5">
                                <div class="hstack gap-2 justify-content-end">
                                    <a href="edit-warehouse.php" class="btn btn-success w-100" id="add-btn"
                                        style="background: linear-gradient(90deg, #10A81B 0%, #06420B 100%);">Edit
