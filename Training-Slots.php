            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">Training Slots</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Menu</a></li>

                                <li class="breadcrumb-item active">Training Slots</li>
                            </ol>
                        </div>
                                ...
                                <div class="col-xxl-3 col-sm-4">
                                    <div>
                                        <select class="js-example-basic-single w-100 form-control" name="state">
                                            ...
                                            <option value="">Veeru </option>
                                            <option value="">rustam </option>
                                            <option value="">divansh </option>
                                            <option value="">Amit jaiswal </option>
                                            <option value="">Sachin </option>
                                            <option value="">Deepak </option>
                                            <option value="">Manmohan </option>
                                            <option value="">Snehil </option>
                                            <option value="">shubham </option>
                                            <option value="">Arun </option>
                                            <option value="">Shalu</option>
                                            <option value="">Rahul </option>
                                            <option value="">Kaushal</option>
                                            <option value="">Seetal</option>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="username">Note</th>
                                            <th class="sort" data-sort="name">Msg to Client</th>
                                            <th class="sort" data-sort="type">Remark</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            <td>
                                                <b>TRUXCARGO5741</b> <br>
                                                Amol Shantaram Khilari <br>
                                                (9112686618)
                                            </td>
                                            <td class="date">06 Apr, 2021</td>
                                            <td>I want training </td>
                                            <td> </td>
                                            <td>he wanted to know about <br> weight reconciliation </td>
                                            <td class="status"><span
                                                    class="badge bg-success-subtle text-success text-uppercase">Completed</span>
                                            </td>
                                            <td>Deepanshu</td>
                                            <td>Arun <br>
                                                28 Sep, 2024 04:55 AM</td>
                                            <td>shubham</td>
