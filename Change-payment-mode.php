            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">Change payment mode</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="mb-4">Import</h5>
                                    ...
                                    <div class="file-design input-group">

                                        <input type="file" class="" id="autoSizingInputGroup"
                                            >
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 mb-3">
                                    <div class="">
                                        <button type="submit" class="btn btn-success w-100 " style="background: linear-gradient(90deg, #10A81B 0%, #06420B 100%);">Import
                                        </button>
                                    </div>
                                </div>
                        </div>
