            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                        <h4 class="mb-sm-0">Dispute Settled
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Dispute Settled
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-3 col-sm-4">
                                    <div>
                                        ...
                                        <select class="js-example-basic-single w-100 form-control" name="state">
                                            ...
                                            <option value="">DELHIVERYDENSE B2B</option>
                                            <option value="">Delhivery Cargo</option>
                                            <option value=" ">Rivigo</option>
                                            <option value="">Gati</option>
                                            <option value="">Oxyzen</option>
                                            <option value="">DTDC B2B</option>
                                            <option value="">Delhivery Lite</option>
                                            <option value="">Smartr</option>
                                            <option value="">Ekart B2B</option>
                                            <option value="">Gati Startup</option>
                                            <option value="">Gati Small Business</option>
                                            <option value="">Gati Enterprise</option>
                                            <option value="">Smartr Startup</option>
                                            <option value="">Smartr Small Business</option>
                                            <option value="">Rivigo Startup</option>
                                            <option value="">Rivigo Small Business</option>
                                            <option value="">Rivigo Enterprise</option>
                                            <option value="">Oxyzen Startup</option>
                                            <option value="">Oxyzen Small Business</option>
                                            <option value="">Oxyzen Enterprise</option>
                                            <option value="">Delhivery Lite Startup</option>
                                            <option value="">Delhivery Lite Small Business</option>
                                            <option value="">Delhivery Lite Enterprise</option>
                                            <option value="">Delhivery Cargo Startup</option>
                                            <option value="">Delhivery Cargo Small Business</option>
                                            <option value="">Delhivery Cargo Enterprise</option>
                                            <option value="">DELHIVERYDENSE B2B Startup</option>
                                            <option value="">DELHIVERYDENSE B2B Small Business</option>
                                            <option value="">DELHIVERYDENSE B2B Enterprise</option>
                                            <option value="">Ekart B2B Startup</option>
                                            <option value="">Ekart B2B Small Business</option>
                                            <option value="">Ekart B2B Enterprise</option>
                                            <option value="">DTDC B2B Startup</option>
                                            <option value="">DTDC B2B Small Business</option>
                                            <option value="">DTDC B2B Enterprise</option>
                                ...
                                <div class="col-xxl-3 col-sm-4">
                                    <div>
                                        ...
                                        <select class="js-example-basic-single w-100 form-control" name="state">
                                            <option value="" selected> Settled By
                                            </option>
                                            <option value="">Kavita</option>
                                            <option value="">Manmohan</option>
                                            <option value="">Lalit</option>
                        ...
                        <table id="example" class="table " style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tracking No.</th>
                                    <th>Details </th>
                                    <th>Entered Wt. & Dim. </th>
                                    <th>Charged Wt. & Dim.</th>
                                    <th>Status </th>
                                    <th>Action </th>
                            ...
                            <tbody>
                                <tr>
                                    <td>Banwari Lal Toshniwal <br>
                                        <b>TRUXCARGO12 </b>
                                    </td>
                                    <td>02-01-2025 </td>
                                    <td>7D108553430 <br>
                                        <b>Courier</b> : DTDC 5kg
                                    </td>
                                    <td><b>Name:</b> DOCUMENTS <br>
                                        <b>Qty</b> : 1
                                    </td>
                                    <td><b>Weight: </b>5000 gms<br>
                                        <b>Dimensions :</b>
                                        1:20x15x15 cm<br>
                                        <b>Vol wt:</b> 1000 gms<br>
                                        <b>Applied Amt:</b> 192.1
                                    </td>
                                    <td><b>Weight:</b> 6500 gms <br>
                                        <b>Charged Amt:</b> 273.88
                                    </td>
                                    <td>Delivered <br>
                                        <b>Mode :</b> Prepaid
                                    </td>
