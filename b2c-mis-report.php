                            ...
                            <table id="example" class="table " style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>OrderID &nbsp;</th>
                                        <th>No of Boxes &nbsp;</th>
                                        <th>Actual Weight (gms) </th>
                                        <th>Dimension Weight(gms)	 </th>
                                        <th>Charged Weight (gms) </th>
                                        <th>Demension (Cms)</th>
                                        <th>Product Description </th>
                                        <th>Invoice Value</th>
                                        <th>Ewaybill</th>
                                        <th>Insurance</th>
                                        <th>Shiping Partner</th>
                                        <th>Manifest Date</th>
                                        <th>Pickup Date	</th>
                                        <th>Expected Date</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> </td>
                                        <td>No </td>
                                        <td>Delhivery Heavy	 </td>
                                        <td>31-12-2024 03:55 PM	 </td>
                                        <td> </td>
                                        <td class="date">206-01-2025	 </td>
                                        <td>VDK EDUVENTURE	</td>
                                        <td>38 B, UDYOG VIHAR ECOTECH 2, GREATER NOIDA, UTTAR PRADESH, Noida, Uttar Pradesh- 201306	 </td>
                                        <td>8595815051</td>
                                        <td>RASHMI MAURYA	</td>
                                        <td>8595815051</td>
                                        <td>PWD AWAS BHELKHA RAJAPUR ROAD , Allahabad, Uttar Pradesh- 212207	 </td>
                                        <td>Noida_Bairangpur_GW (Uttar Pradesh)	</td>
                                        <td> 31-12-2024	</td>
                                        <td class="status">
                                            <span
